...
plus a small three-point difficulty bonus.
...
_LEAGUE_RATE = 0.552   # observed impact per minute across the sample
...
def impact_score(
    ...
    *,
    ...
    three_points_made: int = 0, fouls: int = 0,
) -> float:
